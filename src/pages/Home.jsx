    ...
    >
      <div
        style={{
          ...
          backgroundColor: "rgba(254 225 64, 0.5)",
          backgroundImage:
            "linear-gradient(90deg, rgba(254 225 64, 0.5) 0%, rgba(250 112 154, 0.5) 100%)",
          zIndex: 1,
          borderRadius: "50%",
        }}
      >
      ...
      <div
        style={{
          backgroundImage: `linear-gradient(to top, rgb(3, 3, 13) 40%, rgb(12, 42, 114) 85%, rgb(60, 111, 192) 90%)`,
